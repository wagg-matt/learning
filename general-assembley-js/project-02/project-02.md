...
Begin with the started code shared in Slack.

Unzip the starter code in your usual folder and open the project in Sublime.
...
```
Create a new repo on Github and follow the instructions to push your local repo to it
...
- Have a plan of what you want your app to do
- Have a plan of what you want your app to look like
- Think about how the user will interact with it
- Start by adding all the HTML/CSS
- Then add in the DOM logic to trigger functions when the user interacts with the page
- Take a look at the structure of the data from the various news sources. 
- Map out all of the needed fields/properties from each respective feed.
- Make AJAX requests for the data and `console.log` the response
